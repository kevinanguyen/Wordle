 ...
 * 
 * @author Deborah A. Trytten //professor
 * @version 1.0
 * @author Kevin Nguyen //student author
 * @author Jacob Osifeso //student author
 */
public class Project6 {
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		int countGuess = 1;
		 ...
		 while((countGuess < MAX_GUESSES) && !(guess.equals(word))) {
			 System.out.println("");
			 System.out.println("Enter your guess. Remember the word has 5 letters");
			 guess=keyboard.next();
			 guess=guess.toLowerCase();
		...
		System.out.println("");
		if((countGuess < 6) && (guess.equals(word))) {
			System.out.println(countGuess + " / 6");
		}
	...
	public static String getWordFromFile(int size, Scanner keyboard) throws FileNotFoundException
	{
		...
		String choosenWord = file.next();//read the actual word
		...
		return choosenWord; // this is a stub
	}
	...
	public static int showResult(String chosenWord, String guess)
	{
		...
		for(int x=0; x<guess.length(); ++x) {
			String letter = guess.charAt(x) + "";
			if (guess.charAt(x) == chosenWord.charAt(x)) {
				System.out.print("*");
			}
			else if(chosenWord.contains(letter) && !(guess.charAt(x) == chosenWord.charAt(x))) {
				System.out.print("!");
			}
			else if(guess.charAt(x) != chosenWord.charAt(x)) {
				System.out.print("X");
			}
		}
